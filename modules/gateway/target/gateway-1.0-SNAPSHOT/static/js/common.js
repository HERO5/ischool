...
(function (window, undefined) {
    ...
    jc.tools = {
        formatDate: function (timestamp, format) {
            ...
            var isChinese = (window.language=="chinese"?true:false);
            if (!format) {
                format = (isChinese?"YYYY-MM-dd":"YYYY-MM-dd");
            }
    ...
    jc.param = {
        ...
        stringify: function (obj) {
            ...
            for (var attr in obj) {console.log()
                if (obj[attr] == "undefined") {
                    obj[attr] = "";
                }
                tmp.push(attr + "=" + obj[attr]);
    ...
    jc.fnInit.push(function () {
        if ($("html").niceScroll && !jc.isMobile) {
            $("html").niceScroll({ zindex: 9999, autohidemode: false, cursorwidth: "4px", cursorcolor: "#333", cursorborder: 0, cursoropacitymax: 0.8, smoothscroll: true});
        }
    });
